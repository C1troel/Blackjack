...
namespace Singleplayer
{
    ...
    {
        public class GuardUp : BaseActiveGlobalEffect
        {
            public GuardUp(ActiveGlobalEffectInfo activeGlobalEffectInfo, IEntity entityOwner = null) : base(activeGlobalEffectInfo, entityOwner)
            {}
