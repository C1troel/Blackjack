...
{
    public class SplitReach : BaseEffectCardLogic
    {
        ...
        private void GiveSplitEffect(IEntity target)
        {
            var splitPassiveEffect = new Split(EffectCardInfo.EffectsDuration);

            target.PassiveEffectHandler.TryToAddEffect(splitPassiveEffect);
        }
